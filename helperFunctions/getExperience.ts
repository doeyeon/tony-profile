    ...
    const exp: ProfessionalExperience[] = [
        {
            ...
            summary_paragraph: "My role here was all about juggling the full spectrum of insights analytics, defining success metrics, uncovering insights, and tying them all back to our strategic goals. I was all about making data speak and ensuring everyone from sales to execs were on the same page.",
            ...
            project_summary: "One standout project I spearheaded at IATA was transforming the way we approached our publications and online store. The goal was ambitious: elevate growth and engagement and turn our resources into top-notch tools for the aviation industry.",
            ...
            project_desc2: "Armed with this user feedback, we explored how to reshape our publications to better aid stakeholders in their daily aviation operations. But it wasn't just about gathering data - I dived into analytics, segmenting our data by stakeholder groups. The real magic happened when I built a regression model to dissect the key factors influencing satisfaction with our publications and online store, and how these elements interplayed.",
            project_subheading3: "Influencing Strategy with Data",
            project_desc3: "The culmination of this project was a presentation to IATA's executives and decision-makers. This wasn't just a report; it was a strategic roadmap detailing how we could enhance our publications and online store. I laid out current and potential future use cases, guided by the insights gleaned from our analysis. This project wasn't just about improvement; it was about setting a new standard for how we support the aviation world through our resources."
        },
        {
        ...
        },
        {
            ...
            year: "2021",
            summary_title: "Summary",
            summary_paragraph: "I embraced my role here with a zeal for both front-end and back-end development. My journey here was marked by my never-ending array of projects;  collaborating closely with UI designers, managing synchronization and edits to e-commerce orders, contributing significantly to the backend logic, and building entire app features front-to-back.",
            background_title: "Background",
        ...
        },
        {
            ...
            diagram1: "phaserx_diagram1.png",
            diagram2: "phaserx_diagram2.png",
            skills: "Everything from proof of concept to deployment",
            year: "2021",
            summary_title: "Summary",
            summary_paragraph: "As a co-founder of PhaseRx, I was deeply involved in developing a transformative e-prescription management software, designed to revolutionize the Canadian healthcare industry. My role encompassed a wide range of responsibilities, from co-developing the prototype using a tech stack that included Next.js, Postgres, Docker, Firebase, and React, to designing the backend application framework and deploying the database on AWS RDS. ",
            background_title: "",
