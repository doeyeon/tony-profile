    ...
    const exp: ProfessionalExperience[] = [
        {
            ...
            summary_paragraph: "Boss says, I do. I made lots of powerpoints and gave many presentations. Did some fieldwork and data cleaning. Reports were also written. Main function of my role was for the Commercial Products & Services group.",
            background_title: "",
            background_subtitle: "",
            ...
            project_summary: "One project I spearheaded was transforming the way we approached our strategic partnership program. The goal was to push growth and engagement for key stakeholders in the aviation industry.",
            ...
            project_desc3: "The project concluded with a session involving IATA's key decision-makers, where a comprehensive guideline was discussed, proposing enhancements to the strategic partnership program and drawing on an in-depth analysis of both current and potential future use cases."
        },
        {
            ...
            year: "2022",
            summary_title: "Summary",
            summary_paragraph: "Boss says, I do. I again made powerpoints and gave presentations. Did some due diligence and intel gathering. Defined the scope for some tech features. I strangely had to chase RFPs from the U.S Department of Transportation municipalities.",
            background_title: "",
            background_subtitle: "",
            background_paragraph: "",
            about_title: "",
        ...
        },
        {
            ...
            year: "2021",
            summary_title: "Summary",
            summary_paragraph: "Boss says, I do. Front-end, back-end, data migration, synchronization... With Google and Stack Overflow, anything is possible. I learned how to build platforms front to back.",
            background_title: "",
            background_subtitle: "",
            background_paragraph: "",
            about_title: "",
        ...
        },
        {
            ...
            year: "2021",
            summary_title: "Summary",
            summary_paragraph: "I was involved in co-founding and developing an e-prescription dropbox platform for the Canadian healthcare industry.",
            background_title: "",
            ...
            project_summary: "Co-founding PhaseRx was a venture that involved building and scaling an application from the ground up. My experience extended beyond technical development, collaborating closely with product managers and healthcare professionals. Together, we developed user interview methodologies, created customer journey maps and user stories, and transformed these stories into tangible product features. This collaborative process was instrumental in proposing MVP and secondary features, creating a robust proof of concept, rapid prototyping, and refining our product through continuous client feedback. One of the most fulfilling aspects of this journey was putting together a comprehensive go-to-market strategy with the help of accelerator programs, ensuring that our solution met the needs of the healthcare industry.",
            project_subheading1: "",
            project_desc1: "",
            project_subheading2: "",
            project_desc2: "",
